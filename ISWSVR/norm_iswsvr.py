...
class NormISWSVR():
    ...
    def iswsvr(self,
        ...
        if self.use_before_SVR:
            ...
            # 乘中位数均值
            data_qc_median = np.median(before_svr_data[QC_sample_names], axis=1)
...
if __name__ == '__main__':
    norm_iswsvr = ISWSVR.NormISWSVR(data_path='/Users/iyuge2/Documents/github/NormISWSVR/examples/MatchedIS/demo-has-MatchedIS.csv',
                            ...
                            use_before_SVR=True,
                            use_after_SVR=True)
    norm_iswsvr.run_with_cv_folds(fold_nums=1)
